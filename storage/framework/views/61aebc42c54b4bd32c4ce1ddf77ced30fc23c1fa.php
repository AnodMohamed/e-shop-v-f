                ...
                <div class="row">
                        ...
                        <div class="images p-3">
                            ...
                            <div class="thumbnail text-center"> 
                                <div class="text-center p-4"> 
                                    <img id="main-image" src="<?php echo e(asset('storage/products')); ?>/<?php echo e($product->image); ?>"  style="width: 100%; hightet:300px !important ;" />
                                         ...
                                         <?php if(!empty($img)): ?>
                                            ...
                                            <div class="col-xs-2 col-sm-2 col-md-3" >
                                                <a href="#" onclick="jQuery('.img-carousel').trigger('to.owl.carousel', [0,300]);">
                                                    <img onclick="change_image(this)" src="<?php echo e(asset('storage/gallery')); ?>/<?php echo e($img); ?>" width="70"> 
                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><?php echo e($product->category->name); ?></span>
                                <h5 class="text-uppercase"><?php echo e($product->name); ?></h5>
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price"><?php echo e($product->price); ?>  SR</span>
                                </div>
                            </div>
                            <div class="mt-4 mb-3"> <span class="text-muted">Weight:  <span class="ba-gr"><?php echo e($product->weight); ?></span> </span></div>
                            <div class="mt-4 mb-3 ">
                               <?php
                               ...
                               ?>
                                ...
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar" role="progressbar" style="width:<?php echo e($percent); ?>%; background-color: #02b458;" aria-valuenow="<?php echo e($product->left_quantity); ?>" aria-valuemin="0" aria-valuemax="<?php echo e($product->quantity); ?>"></div>
                                 </div>
                                 <p >only <span style="font-weight: 600"><?php echo e($product->left_quantity); ?> </span>  left</p>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\xampp\E-Shop_Vegetable_and_Fruit_organic\resources\views/livewire/view-product-component.blade.php ENDPATH**/ ?>