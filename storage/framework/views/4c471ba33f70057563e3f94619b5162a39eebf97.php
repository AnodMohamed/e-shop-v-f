        ...
        <div>
            ...
            <div class="flex pb-20 row">
                ...
                <div class="col-2" >
                    ...
                    <a href="<?php echo e(route('admin.category.add')); ?>" class=" block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state"  >
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                               ...
                               <!-- Button trigger modal -->
                                <button type="button" class="btn" data-mdb-toggle="modal" data-mdb-target="#exampleModalDelete<?php echo e($category->id); ?>">
                                ...
                                <div class="modal top fade" id="exampleModalDelete<?php echo e($category->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                                 ...
                                 <a href="<?php echo e(route('admin.category.edit',['category_slug'=>$category->slug])); ?>"  class="btn" >
...
<?php /**PATH C:\xampp\htdocs\xampp\E-Shop_Vegetable_and_Fruit_organic\resources\views/livewire/admin/category-table-component.blade.php ENDPATH**/ ?>