                            ...
                            <?php if($order->delivery == 'ship'): ?>  
                                <?php if($deliver  == null): ?>
                                    <div class="col-3 ">
                                        ...
                                        <a href="<?php echo e(route('admin.orders.selectdriver',['order_id'=>$order->id ])); ?>"  class=" block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state"   >
                                            Select Driver             
                                        </a>
                                    </div>
                                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\xampp\E-Shop_Vegetable_and_Fruit_organic\resources\views/livewire/admin/admin-orderitems-component.blade.php ENDPATH**/ ?>