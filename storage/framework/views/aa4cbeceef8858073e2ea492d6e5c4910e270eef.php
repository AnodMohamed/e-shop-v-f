                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $JobAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Jobad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="border px-4 py-2"><?php echo e($Jobad->name); ?></td>
                            ...
                            <td class="border px-4 py-2">
                               ...
                               <!-- Button trigger modal -->
                                ...
                                <!-- Button trigger modal -->
                                <a href="<?php echo e(route('company.job.add')); ?>" class=" btn btn-primary" id="grid-state"  >
...
<?php /**PATH C:\xampp\htdocs\jfgsb-main\resources\views/livewire/company/company-jobs-table-component.blade.php ENDPATH**/ ?>