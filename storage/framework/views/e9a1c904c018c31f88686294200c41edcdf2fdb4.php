...
<div class="py-5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="container-sm px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
        ...
        <div>
            ...
            <table class=" w-full mb-6 table table-striped">
                <thead>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\xampp\E-Shop_Vegetable_and_Fruit_organic\resources\views/livewire/admin/admin-job-ads-table-component.blade.php ENDPATH**/ ?>